...
with st.sidebar:
    ...
    with st.expander("Teaching Methods", expanded=True):
        learning_labels = [
            ...
            ("Table","Make me a table of that capture of most important information regarding: Current Topic"),
            ("Chunk", "Break large amounts of information into smaller, manageable pieces that are easier to process and remember:"),
            ("Novice","Make me a table of that capture of most important information regarding: Current Topic"),
            ...
            ("Keys", "Start with the overall concept or framework before diving into details, helping students see how pieces fit together:"),
    ...
    with st.expander("Assessment Methods", expanded=True):
        assessment_labels = [
            ...
            ("Compare and Contrast", "Using analogies,smilies, compare and contrast these concepts with other concepts"),
